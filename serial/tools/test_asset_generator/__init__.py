...
def _get_platform_specific_info_getter() -> typing.Callable[
...
def _get_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        ...
        epilog=textwrap.dedent(
            """
            After generating this file, please open an issue at:
    ...
    parser.add_argument("devices", metavar="DEVICE", nargs="+", type=pathlib.Path)
    return parser
